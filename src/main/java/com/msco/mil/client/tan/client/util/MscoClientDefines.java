...
public class MscoClientDefines {
	...
	public static ClientRequestFactory getClientRequestFactory() {
		return RestRequestHelper.createRequestFactory(MscoClientDefines
				.getConsoleUrl(), MscoClientDefines.getAuthorization()
				.getUserId(), MscoClientDefines.getAuthorization()
				.getPassword());
	}
