...
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.BaseDto;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Country;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Data;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.FolderDto;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Friend;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.MailItem;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Movies;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.MusicDto;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Plant;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.State;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Stock;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.Task;
import com.msco.mil.client.sencha.gxt.examples.resources.client.model.TeamSales;
...
public class TestData {
  ...
  public static List<Friend> getFriends()
  {
	  ...
	  friends.add(new Friend("Giovanni", 49, true));
	  friends.add(new Friend("Roz", 46, false));
	  friends.add(new Friend("Rich", 51, true));
